...
export const notifyRiders = async (req, res) => {
  ...
  try {
    ...
    users.forEach((u) => {
      const body = `Your driver to church this Sunday is ${u.driver.name}. Be at ${u.location ? u.location : 'your respective pickup location'} at 7:45 AM. See you at church ⛪️!`;
      u.tokens.forEach((t) => {
        const payload = {
          notification: {
